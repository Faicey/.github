...
Faicey is conceptuatlized as a UIUX AIML modular response system where UIUX = user interface user experience and AIML = Artificial Intelligence Machine Learning
